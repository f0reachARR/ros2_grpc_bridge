...
private:
    static const rosidl_message_type_support_t *get_typesupport(const std::string &type)
    {
        auto ts_lib = rclcpp::get_typesupport_library(type, "rosidl_typesupport_cpp");
        return rclcpp::get_typesupport_handle(type, "rosidl_typesupport_cpp", *ts_lib);
    }
