...
{
private:
    static constexpr auto INTROSPECTION_IDENTIFIER = "rosidl_typesupport_introspection_cpp";
...
public:
    explicit MessageConstructor(const std::string data_type)
    {
        ...
        auto intro_lib = rclcpp::get_typesupport_library(data_type, INTROSPECTION_IDENTIFIER);
        auto typesupport = rclcpp::get_typesupport_handle(data_type, INTROSPECTION_IDENTIFIER, *intro_lib);
